...
int main() {
	...
	while (!infile.eof()) {
        ...
        found = T.retrieve(dND, p);
        cout << "Retrieve --> d:  " << (found ? "found" : "not found") << endl;
        ...
        cout << "T.isEmpty?     " << (T.isEmpty() ? "empty" : "not empty") << endl;
        cout << "T2.isEmpty?  " << (T2.isEmpty() ? "empty" : "not empty") << endl;
        cout << "dup.isEmpty?    " << (dup.isEmpty() ? "empty" : "not empty") << endl;
		dup = T;
