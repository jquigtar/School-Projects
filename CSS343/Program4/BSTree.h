 ...
 * @return true if account inserted, false if account already exists
 */
    bool InsertClassic(ClassicMovie *movie);
     ...
     */
    bool RetrieveFunny(const string &title, Movie *&) const;
 ...
 * @return true if account exists in tree, false if it does not
 */
    bool RetrieveDrama(const string &title, Movie *&) const;
 ...
 * @return true if account exists in tree, false if it does not
 */
    bool RetrieveClassic(const int &year, Movie *&) const;
...
private:
     ...
     */
    bool InsertFunny(Funny *movie, Node *&root);
 ...
 * @return true if node was inserted, false if not.
 */
    bool InsertDrama(Drama *movie, Node *&root);
 ...
 * @return true if node was inserted, false if not.
 */
    bool InsertClassic(ClassicMovie *movie, Node *&root);
     ...
     */
    bool RetrieveFunny(const string &title, Movie *&, Node *root) const;
 ...
 * @return true if account was retrieved, false if not.
 */
    bool RetrieveDrama(const string &title, Movie *&, Node *root) const;
     ...
     * @return true if account was retrieved, false if not.
     */
    bool RetrieveClassic(const int &year, Movie *&, Node *root) const;
