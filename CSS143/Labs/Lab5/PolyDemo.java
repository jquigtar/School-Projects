	...
	public class PolyDemoPanel extends JPanel {		
		...
		public Shape getRandShape() {
			...
			switch( ( int )(Math.random() * 4) ) {
				case 0: 	retVal = new Circle( x,y, getRandInt());//new Square( x, y, getRandInt(), getRandInt() );
							break;
				case 1: 	retVal = new Square( x,y, getRandInt(), getRandInt() );//Cube( x, y, getRandInt(), getRandInt(), getRandInt() );
							break;
				case 2: 	retVal = new Circle( x,y, getRandInt() );
							break;
				case 3: 	retVal = new Square( x,y , getRandInt(), getRandInt());//new Circle( x,y,getRandInt() );////new Cylinder( x,y, getRandInt(), getRandInt() );
							break;				
			}
